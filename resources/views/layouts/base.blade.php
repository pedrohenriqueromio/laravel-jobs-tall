                        ...
                        <div class="block w-80">
                            <div class="flex items-center justify-end">
                                <div class="flex">
                                    ...
                                    @else
                                        <a href="{{ route('login') }}" class="px-3 py-2 rounded-md text-sm font-medium text-indigo-200 hover:text-white">Entrar</a>
                                        @if (Route::has('register'))
                                            <a href="{{ route('register') }}" class="px-3 py-2 rounded-md text-sm font-medium text-indigo-200 hover:text-white">Registrar</a>
                                        @endif
                                    @endauth
                                </div>
                            </div>
